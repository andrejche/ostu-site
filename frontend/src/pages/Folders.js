...
function FileIcon() {
  return (
    <svg className="w-5 h-5 text-[#0B2E5B] dark:text-blue-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <div>
      <div
        ...
        className={
          ...
          (isFolder
            ...
            : node.url
            ? "hover:bg-[#0B2E5B]/5 dark:hover:bg-blue-400/10 hover:border-[#0B2E5B]/20"
      ...
      >
        ...
        <span className={
          ...
          (isFolder ? "text-slate-800 dark:text-slate-200 group-hover:text-amber-700 dark:group-hover:text-amber-400" : "text-slate-700 dark:text-slate-300 group-hover:text-[#0B2E5B] dark:group-hover:text-blue-400")
        }>
          {node.name}
        </span>

        {!isFolder && node.url && (
          <svg className="w-3.5 h-3.5 text-slate-300 dark:text-slate-600 group-hover:text-[#0B2E5B] dark:group-hover:text-blue-400 shrink-0 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    ...
    <div className="absolute inset-x-0 top-0 h-[60vh]">
      ...
      <div className="relative mx-auto max-w-4xl px-4 pt-40 pb-24">
        ...
        {/* Header */}
        <Reveal delay={0.05}>
          <div className="rounded-2xl border border-white/30 dark:border-slate-700/30 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md p-8 shadow-xl shadow-slate-200/60 dark:shadow-none mb-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#0B2E5B]/10 text-xl">📁</div>
                <div>
                  <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">{t("files.title")}</h1>
                  <p className="text-slate-500 dark:text-slate-400 text-sm mt-0.5">{t("files.subtitle")}</p>
                </div>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full sm:w-56 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-700 pl-9 pr-4 py-2.5 text-sm text-slate-800 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#0B2E5B]/20"
                />
              </div>
            </div>
          </div>
        ...
        {/* File tree */}
        <Reveal delay={0.1}>
          <div className="rounded-2xl border border-white/30 dark:border-slate-700 bg-white/70 dark:bg-slate-800 backdrop-blur-md shadow-xl shadow-slate-200/60 dark:shadow-none overflow-hidden">

            {/* Toolbar */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/30">
              <div className="w-3 h-3 rounded-full bg-red-400" />
              <div className="w-3 h-3 rounded-full bg-amber-400" />
              <div className="w-3 h-3 rounded-full bg-green-400" />
              <span className="ml-3 text-xs text-slate-400 dark:text-slate-500 font-mono">ОСТУ / {t("files.title")}</span>
            </div>
        ...
        {/* Legend */}
        <Reveal delay={0.15}>
          <div className="mt-4 flex items-center gap-6 px-2 text-xs text-slate-400 dark:text-slate-500">
