      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-40 pb-24">
        ...
        <Reveal direction="up" delay={0.05}>
          <div className="rounded-2xl border border-white/30 dark:border-slate-700/30 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md p-8 shadow-xl shadow-slate-200/60 dark:shadow-none mb-8">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">{t("praktika.title")}</h1>
            </div>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">{t("praktika.intro")}</p>
          </div>
        </Reveal>
        ...
        <Reveal direction="up" delay={0.05}>
          <div className="flex items-center gap-3 mb-6">
            <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#0B2E5B]/10 text-xl">⚡</div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t("praktika.activitiesTitle")}</h2>
          </div>
        </Reveal>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-10">
          {activities.map((a, i) => (
            <Reveal key={a.title} direction="up" delay={i * 0.07}>
              <div className="group rounded-2xl border border-white/30 dark:border-slate-700/30 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md p-6 shadow-xl shadow-slate-200/60 dark:shadow-none hover:bg-white/90 dark:hover:bg-slate-700/70 hover:scale-[1.02] transition-all duration-300 h-full">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">{a.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
        ...
        <Reveal direction="up" delay={0.05}>
          <div className="rounded-2xl border border-white/30 dark:border-slate-700/30 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md p-8 shadow-xl shadow-slate-200/60 dark:shadow-none mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t("praktika.toolsTitle")}</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">{t("praktika.toolsDesc")}</p>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              {tools.map((tool) => (
                  <div key={tool.name}
                    className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3 hover:border-[#0B2E5B]/30 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
        ...
        <Reveal direction="up" delay={0.05}>
          <div className="rounded-2xl border border-white/30 dark:border-slate-700/30 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md p-8 shadow-xl shadow-slate-200/60 dark:shadow-none">
            <div className="flex items-center gap-3 mb-5">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#0B2E5B]/10 text-xl">🎓</div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t("praktika.whyTitle")}</h2>
            </div>
            <div className="grid gap-4 md:grid-cols-3">
              {whyItems.map((item) => (
                <div key={item.title} className="rounded-xl bg-[#0B2E5B]/5 dark:bg-[#0B2E5B]/20 border border-[#0B2E5B]/10 dark:border-[#0B2E5B]/30 p-5">
